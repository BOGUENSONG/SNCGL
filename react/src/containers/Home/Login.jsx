                ...
                <div className="bg-info d-flex justify-content-center col">
                    <Form className="w-50 m-3">
                        <fieldset >
                            ...
                            <div>회원이 아니신가요? <a href="/register" class="link-danger">회원가입</a></div>
                            <div className="row">
                                <Button className="w-40 m-3 col btn-warning" type="submit">취소</Button>
                                <Button className="w-40 m-3 col " type="submit">로그인</Button>
                            </div>
